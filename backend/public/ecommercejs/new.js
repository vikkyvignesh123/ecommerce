...
//   // Fetch product list
//   // Assuming user data in localStorage
...
// //       const toggleButton = allDetails.querySelector(".cartlogo");
...
// //         if (!isAdded) {
// //           fetch("http://localhost:3000/api/v1/cart/addcart", {
// //             method: "POST",
...
// //       const productImage = allDetails.querySelector(".productdetailsimg");
// //       productImage.addEventListener("click", () => {
// //         productDescription(d); // Your custom function
// //       });
// //     });
// //   })
...
// // // Update cart count
// // function fetchUserCartCount() {
// //   if (!user?.userId) return;

// //   fetch("http://localhost:3000/api/v1/cart/getmycart")
// //     .then(res => res.json())
// //     .then(data => {
// //       if (data.success && Array.isArray(data.data)) {
// //         const count = data.data.filter(item => item.userId === user.userId).length;
